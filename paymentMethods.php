<div class="paymentMethods page-popup" id="paymentMethods"  style="display: none;">
  ...
  <div class="container paymentcont">
    ...
    <div class="row">
      <div class="col-xs-6 col-md-3">
          <div class="method giro modal-opener" data="payment">
            <div class="pay-logo"><img src="assets/img/giro.png"></div>
          </div>
      </div>
      <div class="col-xs-6 col-md-3">
        <div class="method citadel modal-opener" data="payment">
          <div class="pay-logo"><img src="assets/img/citadel.png"></div>
        </div>
      </div>
      <div class="col-xs-6 col-md-3">
          <div class="method trustly modal-opener" data="payment">
      ...
      <div class="row">
      <div class="col-xs-6 col-md-3">
          <div class="method ideal modal-opener" data="payment">
